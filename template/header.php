...
<nav class="<?= ($currentPage === 'introduce.php' || $currentPage === 'track-order.php') ? 'border-b border-indigo-500/10' : 'glass-effect sticky top-0 z-50 border-b border-indigo-500/10' ?>">
