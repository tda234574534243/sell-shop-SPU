            ...
            <div class="main__container">
                ...
                <?php else: ?>
                    ...
                    <div class="alert alert-info" role="alert">
                        <h4 class="alert-heading">nhung con song xo</h4>
                        <p>Sử dụng Page Builder trong Admin để thêm nội dung cho trang này.</p>
                        <hr>
                        <p class="mb-0">Vào <strong>Admin > Quản lý trang > nhung con song xo</strong> để bắt đầu chỉnh sửa.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
