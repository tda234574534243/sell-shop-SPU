                ...
                <?php else: ?>
                    ...
                    <div class="soft-shadow glass-effect rounded-2xl p-6 border border-indigo-500/20">
                        <div class="flex items-center gap-3 mb-4">
                            <i class="fas fa-star text-3xl text-indigo-400"></i>
                            <h2 class="font-montserrat text-2xl font-bold text-slate-100">Sản Phẩm Mới</h2>
                        </div>
                        ...
                        <p class="text-slate-400 text-sm">
                            ...
                            Vào <strong>Admin > Quản lý trang > Sản phẩm mới</strong> để bắt đầu chỉnh sửa.
                        </p>
                    </div>
                <?php endif; ?>
            </div>
